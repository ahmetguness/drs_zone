...
class F1ApiClient {
  ...
  private static _instance: F1ApiClient;
  ...
  public static getInstance(): F1ApiClient {
    if (!F1ApiClient._instance) {
      F1ApiClient._instance = new F1ApiClient();
    }
    return F1ApiClient._instance;
  }
...
export const f1ApiClient = F1ApiClient.getInstance();
